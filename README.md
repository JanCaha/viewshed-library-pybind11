...
The easiest way to install is via conda from the [custom channel](https://jancaha.github.io/conda-channel):

```bash
conda install -c https://jancaha.github.io/conda-channel -c conda-forge viewshed
```
